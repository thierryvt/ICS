...
namespace DAL
{
    public class ICSInitializer : DropCreateDatabaseIfModelChanges<IcsContext>
    {
        ...
        protected override void Seed(IcsContext context)
        {
            ...
            {
                new Opdracht { Datum = DateTime.Parse("10/12/2016"), Naam = "Vermeylen Referentienummer 1", NummerPlaat =Vrachtwagens.ElementAt(0).NummerPlaat, ChauffeurID = Chauffeurs.ElementAt(0).Id, OpdrachtID=1, Afgehandeld = false},
                new Opdracht { Datum = DateTime.Parse("10/12/2016"), Naam = "Amazon Referentienummer XYZFDF",NummerPlaat =Vrachtwagens.ElementAt(1).NummerPlaat, ChauffeurID = Chauffeurs.ElementAt(1).Id, OpdrachtID=2, Afgehandeld = false},
                new Opdracht { Datum = DateTime.Parse("10/12/2016"), Naam = "Bol 123 AAA",NummerPlaat =Vrachtwagens.ElementAt(2).NummerPlaat, ChauffeurID = Chauffeurs.ElementAt(2).Id, OpdrachtID=3, Afgehandeld = false},
                new Opdracht { Datum = DateTime.Parse("10/12/2016"), Naam = "Coolblue AAfgdfg58887",NummerPlaat =Vrachtwagens.ElementAt(0).NummerPlaat, ChauffeurID = Chauffeurs.ElementAt(0).Id, OpdrachtID=4, Afgehandeld = true},
                new Opdracht { Datum = DateTime.Parse("10/12/2016"), Naam = "MCS Titonic 899",NummerPlaat =Vrachtwagens.ElementAt(1).NummerPlaat, ChauffeurID = Chauffeurs.ElementAt(1).Id, OpdrachtID=5, Afgehandeld = false},
                new Opdracht { Datum = DateTime.Parse("10/12/2016"), Naam = "Zink etgfg5",NummerPlaat =Vrachtwagens.ElementAt(2).NummerPlaat, ChauffeurID = Chauffeurs.ElementAt(2).Id, OpdrachtID=6, Afgehandeld = true },
